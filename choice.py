...
def start(num_ork):
    ...
    # отрисовываем текст
    rect_panel = (0, 10 - 10, 260, text_comp_h + 20)
    pygame.draw.rect(screen, (255, 0, 0), rect_panel, 1)
    # рисуем окантовку
    ...
    # отрисовываем текст
    rect_button = (270 - 10, 90 - 10,  text_comp_w + 20, text_comp_h + 20)
    pygame.draw.rect(screen, (0, 0, 0), rect_button, 2)
    ...
    # отрисовываем текст
    rect_button = (270 - 10, 180 - 10, text_comp_w + 70, text_comp_h + 20)
    pygame.draw.rect(screen, (0, 0, 0), rect_button, 2)
    # рисуем окантовку кнопки
    ...
    # отрисовываем текст
    rect_panel = (0, 300 - 10, 488, text_comp_h + 20)
    pygame.draw.rect(screen, (255, 0, 0), rect_panel, 1)
    ...
    for i in range(kol_str):
        ...
        # устанавливаем шрифт
        text_comp = font_comp.render(ork_info[(len(ork_info) // kol_str) * i:(
            len(ork_info) // kol_str) * (i + 1)], True, (255, 0, 0))
        # создаем текст
        ...
        while running:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if pygame.mouse.get_pos()[0] > 260:
                        if pygame.mouse.get_pos()[0] < 498:
                            ...
                            if pygame.mouse.get_pos()[1] > 80:
                                if pygame.mouse.get_pos()[1] < 135:
                                    ...
                                    num_ork += 1
                                    # увеличиваем номер орка, т.к. в этих
                                    # координатах находится кнопка следующий
                                    if num_ork > len(orks) - 1:
                                        # если номер орка больше
                                        # чем максимальный индекс списка
                                        num_ork = 0
                    ...
                    if pygame.mouse.get_pos()[0] > 260:
                        if pygame.mouse.get_pos()[0] < 498:
                                # проверка на координаты точки по х
                            if pygame.mouse.get_pos()[1] > 170:
                                if pygame.mouse.get_pos()[1] < 225:
                                        # проверка на координаты точки по у
                                    but_cl()
                                    # воспроизводим звук нажатия на мышь
                                    num_ork -= 1
                                    # уменьшаем номер орка, т.к. в этих
                                    # координатах находится кнопка предыдущий
                                    if num_ork < 0:
